...
public class instructionStudent extends javax.swing.JFrame {
    ...
    public instructionStudent() {
     ...
     public instructionStudent(String userName1) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("During the exam :\n\n1.The student may or may not use his/her textbook.\n\n2.Student must complete the 10 multiple choice question.\n\n3.Student must not stop the session and then return to it.\n\nNo of question : 10\nExam Duration : 10 mins\nAll the Best...");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 88, 1280, 533));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(449, 633, -1, -1));
